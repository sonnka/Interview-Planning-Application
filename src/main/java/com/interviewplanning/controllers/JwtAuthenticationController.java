...
import com.interviewplanning.controllers.dto.CandidateDto;
import com.interviewplanning.controllers.dto.FacebookOauthInfoDto;
import com.interviewplanning.controllers.dto.JwtRequest;
import com.interviewplanning.controllers.dto.JwtResponse;
import com.interviewplanning.exceptions.SecurityException;
...
import com.interviewplanning.security.JwtUserDetailsService;
...
public class JwtAuthenticationController {
  ...
  public ResponseEntity<?> createAuthenticationToken(
    ...
    Map<FacebookUtil.FacebookScopes, String> userScopes;
    try {
    ...
    String email = userScopes.get(FacebookUtil.FacebookScopes.EMAIL);
    String name = userScopes.get(FacebookUtil.FacebookScopes.NAME);
